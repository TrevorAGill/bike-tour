...
public class Sql2oCampsiteDaoTest {
    ...
    public void returnListOfAllCampsites() throws Exception {
        Campsite newCampsite = newCampsite();
        Campsite newCampsite2 = new Campsite("Lewis and Clarke", 4, 3, 1, "yes", "yes", "yes", "groceries", "no phone");
        campsiteDao.add(newCampsite);
    ...
    public void getAllByTour_returnsAllCampsitesForTour() throws Exception {
        Campsite newCampsite = newCampsite();
        Campsite newCampsite2 = new Campsite("Lewis and Clarke", 4, 3, 1, "yes", "yes", "yes", "groceries", "no phone");
        Campsite newCampsite3 = new Campsite("Lewis and Clarke", 4, 3, 2, "yes", "yes", "yes", "groceries", "no phone");
        campsiteDao.add(newCampsite);
        campsiteDao.add(newCampsite2);
    ...
    public void updateASingleCampsite() throws Exception {
        ...
        campsiteDao.update("Test",4,4, 1, foundCampsite.getId(), "yes", "yes", "yes", "groceries", "no phone");
    ...
    public Campsite newCampsite() {
        return new Campsite("PCT Camp", 3, 10, 1, "yes", "yes", "yes", "groceries", "no phone");
    }
